...
export default function Product({ product = {} }) {
    return <div className="rounded-4xl bg-purple-100 bg-opacity-75 text-center px-10 py-6 sm:py-10">
        ...
        <p className="mt-4 text-black text-opacity-70">{product.shortDesc}</p>
